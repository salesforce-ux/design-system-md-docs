...
| .slds-is-open | Opens dropdown menu when invoked on click |   | .slds-dropdown-trigger_click |   | true |
| .slds-dropdown-trigger_click | If someone is using javascript for click to toggle - this modifier will help |   | .slds-dropdown-trigger |   |   |
| .slds-dropdown-trigger_hover | If someone is using javascript for click to toggle - this modifier will help |   | .slds-dropdown-trigger |   |   |
| .slds-dropdown-trigger | Initializes a trigger element around the dropdown | dev-ready | div, span, li | true |   |
| .slds-dropdown-trigger | A Menu offers a list of actions or functions that a user can access. | dev-ready |   |   |   |